...
--
-- Host: 127.0.0.1:3307
-- Tempo de geração: 02/06/2026 às 02:58
...
CREATE TABLE `atendimentos` (
  ...
  `status` enum('pendente','aguardando','em_andamento','finalizado','cancelado') DEFAULT 'pendente',
...
CREATE TABLE `tipos_atendimentos` (
  ...
  `nome` varchar(100) NOT NULL,
  `descricao` text NOT NULL,
  `status` enum('presencial','online') DEFAULT 'presencial'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
